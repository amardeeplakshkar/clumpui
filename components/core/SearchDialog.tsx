      ...
      <DialogTrigger className='cursor-pointer outline-0 focus-visible:border-0 '>
        <div className="max-w-[200px] pointer-events-none">
          <div className={cn(
            ...
            <Input className='-mt-1 border-0 outline-hidden' placeholder="Search..." />
      ...
      <DialogContent className='p-2 gap-1 overflow-hidden rounded-xl'>
        ...
        <div className='flex items-center justify-center gap-2'>
          ...
          <Input
            ...
            className='focus-visible:ring-0 border-0 focus-visible:border-0 outline-hidden focus:outline-hidden'
            value={searchQuery}
