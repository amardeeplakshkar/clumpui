...
export default function TweetCard({
    ...
    content = [
        "All components from clumpui can now be open in @v0 🎉",
            ...
            >
                <div
                    className={cn(
                        ...
                        "shadow-2xs",
                        "will-change-transform translate-z-0",
                        "before:absolute before:inset-0 before:bg-linear-to-br before:from-black/2 before:to-black/1 dark:before:from-white/3 dark:before:to-white/1 before:opacity-0 before:transition-opacity before:pointer-events-none",
