      ...
      return (
        <div
          ...
          className={cn(
            ...
            "[&>pre>code>:not(.focused)]:group-hover/left:opacity-100! [&>pre>code>:not(.focused)]:group-hover/left:blur-none!",
            "[&>pre>code>:not(.focused)]:group-hover/right:opacity-100! [&>pre>code>:not(.focused)]:group-hover/right:blur-none!",
            "[&>pre>code>.add]:bg-[rgba(16,185,129,.16)] [&>pre>code>.remove]:bg-[rgba(244,63,94,.16)]",
            "[&>pre>code>:not(.focused)]:group-hover/left:transition-all [&>pre>code>:not(.focused)]:group-hover/left:duration-300",
            "[&>pre>code>:not(.focused)]:group-hover/right:transition-all [&>pre>code>:not(.focused)]:group-hover/right:duration-300",
          )}
